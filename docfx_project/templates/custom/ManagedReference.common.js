...
function getDefinitions(category) {
  var namespaceItems = {
    ...
    interface: {
      inInterface: true,
      typePropertyName: "inInterface",
      id: "interfaces",
    },
    enum: { inEnum: true, typePropertyName: "inEnum", id: "enums" },
    delegate: {
      inDelegate: true,
      typePropertyName: "inDelegate",
      id: "delegates",
    },
  };
  var classItems = {
    ...
    attachedproperty: {
      inAttachedProperty: true,
      typePropertyName: "inAttachedProperty",
    ...
    attachedevent: {
      inAttachedEvent: true,
      typePropertyName: "inAttachedEvent",
      id: "attachedEvents",
    },
    operator: {
      inOperator: true,
      typePropertyName: "inOperator",
      id: "operators",
    },
